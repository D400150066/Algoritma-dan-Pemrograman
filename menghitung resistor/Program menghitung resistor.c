...
int main() {
    ...
    printf("D400150066\n");
    printf("Program perhitungan resistor gelang warna\n");
    printf("Keterangan Warna & Angka gelang\n");
    /*keterangan angka gelang*/
    printf("\t| hitam         = 0         |\n");
    printf("\t| coklat        = 1         |\n");
    printf("\t| merah         = 2         |\n");
    printf("\t| orange        = 3         |\n");
    ...
    printf("\t| perak         = 10 persen |\n");
    printf("\t| tak berwarna  = 20 persen |\n");
    printf("\nMasukkan jumlah gelang antara 3 s/d 6");
    printf("\n---------------------------\n");
    printf("Masukkan jumlah gelang : ");
		scanf("%d", &GELANG );
